# Moda #
  ...
  1. Система вопросов ответов
  1. Лента новостей с кратким обзором
  1. Полезная инвормация такая как:
  * Время начала и конца шабата
  * Погода
  * Цены ценных бумаг

[Перейти на страницу проекта](http://www.lolnik.ath.cx/moda/)
